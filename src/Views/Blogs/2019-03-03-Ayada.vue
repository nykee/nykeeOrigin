    ...
    <Row type="flex" align="center" justify="center" class="blog-container">
        <i-col :lg="{span:18}" class="blog-content">
            ...
            <section class="main-body">
                ...
                距离马尔代夫首都马累有点远，上岛需要先乘坐1个小时的内陆飞机，然后再转45分钟左右的快艇才到。</p>
                <Divider>下面就是放图时间，流量预警！！！</Divider>
                ...
                <CustomPicture imgSrc="https://image.nykee.cn/bottle.jpg"
                               ...
                               className="commonBlogImg"
                ></CustomPicture>
                <h3 class="photo-title">我们的沙屋房间号码是203，emmm还不错，离餐厅蛮近的，后面看看其实沙屋都差不多，没啥好位置和差位置</h3>
                <CustomPicture imgSrc="https://image.nykee.cn/aya_203.jpg"
                               srcSet="https://image.nykee.cn/aya_203.jpg"
                               className="commonBlogImg"
                ></CustomPicture>
                <h3 class="photo-title">水屋幸运地拿到了最好的520，不过也是用沙屋晚退房4个小时换来的，还不错</h3>
