<template>
  <div class="comment-container">
    ...
    <Row type="flex" justify="center" align="middle" class="comment-header">
      <i-col :xs={span:24} :sm={span:24} :md={span:24} :lg={span:24} >
        <span>Comments</span>
    ...
    <Row type="flex" justify="center" align="middle" class="item-row">
      <i-col :xs={span:24} :sm={span:24} :md={span:24} :lg={span:24} v-if="!isMobile">
        <Poptip   word-wrap>
      ...
      <i-col :xs={span:24} :sm={span:24} :md={span:24} :lg={span:24} class="emotion-toggle-container" v-show="isEmojShow&&isMobile" >
    ...
    <Row type="flex" justify="center" align="middle">
      <i-col :xs={span:24} :sm={span:24} :md={span:24} :lg={span:24} class="textA-center">
